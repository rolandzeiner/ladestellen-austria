...
`,Me=["Type 2","CCS","CHAdeMO","Type 1","Tesla","Schuko","CEE"],Ie=[{key:"green_energy",icon:"mdi:leaf",label_key:"amenities.green_energy"},{key:"austrian_ecolabel",icon:"mdi:certificate-outline",label_key:"amenities.austrian_ecolabel"},{key:"free_parking",icon:"mdi:parking",label_key:"amenities.free_parking"},{key:"roofed_parking",icon:"mdi:home-roof",label_key:"amenities.roofed_parking"},{key:"illuminated_parking",icon:"mdi:lightbulb-outline",label_key:"amenities.illuminated_parking"},{key:"barrier_free",icon:"mdi:wheelchair-accessibility",label_key:"amenities.barrier_free"},{key:"catering",icon:"mdi:silverware-fork-knife",label_key:"amenities.catering"},{key:"bathrooms",icon:"mdi:toilet",label_key:"amenities.bathrooms"},{key:"resting",icon:"mdi:sofa",label_key:"amenities.resting"}],Fe=[{key:"APP",icon:"mdi:cellphone",label_key:"auth.app"},{key:"QR",icon:"mdi:qrcode",label_key:"auth.qr"},{key:"RFID_READER",icon:"mdi:credit-card-wireless-outline",label_key:"auth.rfid"},{key:"CHARGING_CONTRACT",icon:"mdi:handshake-outline",label_key:"auth.contract"},{key:"DEBIT_CARD",icon:"mdi:credit-card-outline",label_key:"auth.debit"},{key:"CREDIT_CARD",icon:"mdi:credit-card",label_key:"auth.credit"},{key:"CONTACTLESS_CARD_SUPPORT",icon:"mdi:contactless-payment",label_key:"auth.contactless"}];let He=class extends se{constructor(){super(...arguments),this._config={type:"ladestellen-austria-card"}}setConfig(e){this._config={...e}}render(){Re(this.hass?.language);const e=this._config.connector_types??[],t=this._config.amenities??[],i=this._config.payment_methods??[];return V`
      <div class="editor">
        <div class="editor-section">
          ...
          ${this.hass?V`
                <ha-selector
                  ...
                  .configValue=${"entity"}
                  .label=${Ne("editor.entity")}
                  .required=${!0}
                  @value-changed=${this._valueChanged}
                ></ha-selector>
              `:V`<p>${Ne("common.loading")}</p>`}

          <ha-textfield
            label=${Ne("editor.name")}
        ...
        <div class="editor-section">
          <div class="section-header">${Ne("editor.section_display")}</div>
          ...
          ${this.hass?V`
                <ha-selector
                  ...
                  .label=${Ne("editor.max_stations")}
                  @value-changed=${this._valueChanged}
                ></ha-selector>
              `:j}

          <div class="toggle-row">
            <label>${Ne("editor.show_hero")}</label>
            <ha-switch
          ...
          <div class="toggle-row">
            <label>${Ne("editor.show_pricing")}</label>
            <ha-switch
          ...
          <div class="toggle-row">
            <label>${Ne("editor.show_amenities")}</label>
            <ha-switch
          ...
          <div class="toggle-row">
            <label>${Ne("editor.sort_by_power")}</label>
            <ha-switch
          ...
          <div class="toggle-row">
            <label>${Ne("editor.logo_adapt_to_theme")}</label>
            <ha-switch
        ...
        <div class="editor-section">
          <div class="section-header">${Ne("editor.section_filters")}</div>

          <div class="toggle-row">
            <label>${Ne("editor.only_available")}</label>
            <ha-switch
          ...
          <div class="toggle-row">
            <label>${Ne("editor.only_free")}</label>
            <ha-switch
          ...
          <div class="toggle-row">
            <label>${Ne("editor.only_open")}</label>
            <ha-switch
          ...
          <div class="editor-hint">${Ne("editor.connector_filter_hint")}</div>
          <div class="chip-row">
            ${Me.map(t=>V`
                <button
                  type="button"
          ...
          <div class="editor-hint">${Ne("editor.amenity_filter_hint")}</div>
          <div class="chip-row">
            ${Ie.map(e=>V`
                <button
                  type="button"
          ...
          <div class="editor-hint">${Ne("editor.payment_filter_hint")}</div>
          <div class="chip-row">
            ${Fe.map(e=>V`
                <button
                  type="button"
    ...
    `}_renderPinSection(){const e=this._config.entity,t=e?this.hass?.states[e]:void 0,i=t?.attributes?.stations??[],n=this._config.pinned_station_ids??[],a=new Set(n),r=new Set(i.map(e=>e.stationId)),o=n.filter(e=>!r.has(e));return V`
      <div class="editor-section">
    ...
    `}_renderHero(e,t,i,n){if(!e)return V`<div class="hero hero--empty">
        <div class="hero-label">${Ne("card.no_stations")}</div>
      </div>`;const a=this._formatKm(e.distance),r=this._heroCity(e),o=t?this._formatKm(t.distance):a,s=Ne("card.hero_range").replace("{min}",this._formatKm(e.distance)).replace("{max}",o),l=i===n?Ne("card.hero_count").replace("{count}",String(i)):Ne("card.hero_count_filtered").replace("{filtered}",String(i)).replace("{total}",String(n));return V`
      <div class="hero">
        ...
        <div class="hero-context">
          <div class="hero-context-1">
            ${Ne("card.hero_context").replace("{city}",r)}
          </div>
          ...
          <div class="station-grid">
            <span class="station-metrics">
              ${i?V`<ha-icon
                    class="pin-indicator"
                    icon="mdi:pin"
                    title=${Ne("card.pinned")}
                    aria-label=${Ne("card.pinned")}
                  ></ha-icon>`:j}
              ${r>0?V`<span
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label=${Ne("card.open_in_maps")}
    ...
    `}_renderRackSlot(e){const t=this._pointPowerType(e),i=this._rackSlotStatus(e.status),n=this._pointTooltip(e),a=this._pointAriaLabel(e,t),r=t?V`<span class="power-badge" data-type=${t}
          >${t.toUpperCase()}</span
      ...
      `;const o=this._pointConnectorLabel(e),s=this._formatKw(e.capacityKw);return V`
      <div
        class="rack-slot"
        role="group"
        aria-label=${a}
      ...
      <div class="detail-section">
        ...
        <div class="hours-row">
          <div class="hours-lines">
            ${i.map(e=>V`<div class="hours-line">${e}</div>`)}
          </div>
    ...
    `}_formatOpeningHours(e){const t=[];for(const i of e){const e=this._formatSingleRange(i);e&&t.push(e)}return t}_formatSingleRange(e){const t=this._shortDay(e.fromWeekday),i=this._shortDay(e.toWeekday);if(!t||!i)return null;const n="00:00"===e.fromTime&&("23:59"===e.toTime||"24:00"===e.toTime),a=e.fromWeekday===e.toWeekday?t:`${t}–${i}`;return n?`${a} ${Ne("card.always_open_short")}`:`${a} ${e.fromTime}–${e.toTime}`}_shortDay(e){switch((e??"").toUpperCase()){case"MONDAY":return Ne("weekday.mo");case"TUESDAY":return Ne("weekday.tu");case"WEDNESDAY":return Ne("weekday.we");case"THURSDAY":return Ne("weekday.th");case"FRIDAY":return Ne("weekday.fr");case"SATURDAY":return Ne("weekday.sa");case"SUNDAY":return Ne("weekday.su");default:return""}}_isOpenNow(e,t,i){if(!e||0===e.length)return null;const n=this._minuteOfWeek(t,i);if(null==n)return null;for(const t of e){const e=this._hoursToMow(t.fromWeekday,t.fromTime),i=this._hoursToMow(t.toWeekday,t.toTime);if(null!=e&&null!=i)if(e<=i){if(n>=e&&n<=i)return!0}else if(n>=e||n<=i)return!0}return!1}_minuteOfWeek(e,t){try{const i=new Intl.DateTimeFormat("en-US",{timeZone:t,weekday:"short",hour:"2-digit",minute:"2-digit",hour12:!1}).formatToParts(e),n=i.find(e=>"weekday"===e.type)?.value??"",a=i.find(e=>"hour"===e.type)?.value??"",r=i.find(e=>"minute"===e.type)?.value??"",o=Ve[n];if(void 0===o)return null;let s=parseInt(a,10);const l=parseInt(r,10);return Number.isFinite(s)&&Number.isFinite(l)?(24===s&&(s=0),1440*o+60*s+l):null}catch{return null}}_hoursToMow(e,t){const i=Be[(e??"").toUpperCase()];if(void 0===i)return null;const[n,a]=(t??"").split(":"),r=parseInt(n,10),o=parseInt(a,10);return Number.isFinite(r)&&Number.isFinite(o)?1440*i+60*r+o:null}_paymentChips(e){const t=new Set,i=[];for(const n of e)for(const e of n.authenticationMode??[]){if(t.has(e))continue;t.add(e);const n=this._authLabel(e);n&&i.push(n)}return i}_authLabel(e){switch(e){case"APP":return{icon:"mdi:cellphone",label:Ne("auth.app")};case"QR":return{icon:"mdi:qrcode",label:Ne("auth.qr")};case"RFID_READER":return{icon:"mdi:credit-card-wireless-outline",label:Ne("auth.rfid")};case"CHARGING_CONTRACT":return{icon:"mdi:handshake-outline",label:Ne("auth.contract")};case"DEBIT_CARD":return{icon:"mdi:credit-card-outline",label:Ne("auth.debit")};case"CREDIT_CARD":return{icon:"mdi:credit-card",label:Ne("auth.credit")};case"CONTACTLESS_CARD_SUPPORT":return{icon:"mdi:contactless-payment",label:Ne("auth.contactless")};default:return null}}_feesLine(e){const t=e.map(e=>e.startFeeCent??0).filter(e=>e>0),i=e.map(e=>({cent:e.blockingFeeCentMin??0,fromMin:e.blockingFeeFromMinute??0})).filter(e=>e.cent>0&&e.fromMin>0),n=[];if(t.length>0){const e=Math.max(...t);n.push(`+ ${this._formatEuro(e)} € ${Ne("card.start_fee_label")}`)}if(i.length>0){const e=Math.max(...i.map(e=>e.cent)),t=Math.min(...i.map(e=>e.fromMin));n.push(`${this._formatCent(e)} ${Ne("card.blocking_fee_label").replace("{from}",String(t))}`)}return n.length>0?n.join(", "):null}_statusLevel(e,t,i,n=null){if(!t)return"inactive";if(!1===n)return"inactive";const a=i.length;if(!e||0===a)return"unknown";let r=0,o=0,s=0;for(const e of i){const t=this._normStatus(e.status);"AVAILABLE"===t?r++:"CHARGING"===t||"OCCUPIED"===t||"RESERVED"===t||"BLOCKED"===t?o++:"OUTOFORDER"!==t&&"FAULTED"!==t&&"INOPERATIVE"!==t&&"UNAVAILABLE"!==t||s++}return 0===r?0===o&&s>0?"inactive":"busy":r<a?"partial":"ok"}_statusAria(e,t,i){return"inactive"===e?Ne("card.inactive"):"unknown"===e?Ne("card.status_unknown"):`${t} / ${i} ${Ne("card.live_suffix")}`}_toggle(e){const t=new Set(this._expanded);t.has(e)?t.delete(e):t.add(e),this._expanded=t}_onKey(e,t){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),this._toggle(t))}_priceText(e){if(0===e.length)return"";if(e.some(e=>e.freeOfCharge))return Ne("card.gratis");const t=e.filter(e=>!e.freeOfCharge&&e.priceCentKwh>0).map(e=>e.priceCentKwh);if(t.length>0)return`${this._formatEuro(Math.min(...t))} €/kWh`;const i=e.filter(e=>!e.freeOfCharge&&e.priceCentMin>0).map(e=>e.priceCentMin);return i.length>0?`${this._formatEuro(Math.min(...i))} €/min`:""}_formatEuro(e){const t=e/100;try{return new Intl.NumberFormat("de-AT",{minimumFractionDigits:2,maximumFractionDigits:2}).format(t)}catch{return t.toFixed(2)}}_address(e){const t=[];e.street&&t.push(e.street);const i=[e.postCode,e.city].filter(Boolean).join(" ");return i&&t.push(i),t.join(", ")}_amenityItems(e){return[{flag:e.greenEnergy,icon:"mdi:leaf",label:Ne("amenities.green_energy")},{flag:e.austrianEcoLabel,icon:"mdi:certificate-outline",label:Ne("amenities.austrian_ecolabel")},{flag:e.freeParking,icon:"mdi:parking",label:Ne("amenities.free_parking")},{flag:e.roofedParking,icon:"mdi:home-roof",label:Ne("amenities.roofed_parking")},{flag:e.illuminatedParking,icon:"mdi:lightbulb-outline",label:Ne("amenities.illuminated_parking")},{flag:(e.barrierFreeParkingPlaces??0)>0,icon:"mdi:wheelchair-accessibility",label:Ne("amenities.barrier_free")},{flag:e.cateringService,icon:"mdi:silverware-fork-knife",label:Ne("amenities.catering")},{flag:e.bathroomsAvailable,icon:"mdi:toilet",label:Ne("amenities.bathrooms")},{flag:e.restingFacilities,icon:"mdi:sofa",label:Ne("amenities.resting")}].filter(e=>e.flag)}_formatKm(e){const t="number"==typeof e?e:parseFloat(String(e??""));if(!Number.isFinite(t))return"–";try{return new Intl.NumberFormat("de-AT",{minimumFractionDigits:2,maximumFractionDigits:2}).format(t)}catch{return t.toFixed(2)}}_shortConnector(e,t){switch(e){case"TYPE_2_AC":return"Type 2";case"COMBO2_CCS_DC":return"CCS";case"CHADEMO":return"CHAdeMO";case"TYPE_1_AC":return"Type 1";case"TESLA_S":case"TESLA_R":return"Tesla";case"OTHER":return"DOMESTIC_F"===t?"Schuko":t?.startsWith("CEE")?"CEE":t??"?";default:return e?.replace(/_/g," ")??t??"?"}}static{this.styles=Le}};e([he({attribute:!1})],We.prototype,"hass",void 0),e([ue()],We.prototype,"config",void 0),e([ue()],We.prototype,"_expanded",void 0),We=e([ce("ladestellen-austria-card")],We);export{We as LadestellenAustriaCard};
