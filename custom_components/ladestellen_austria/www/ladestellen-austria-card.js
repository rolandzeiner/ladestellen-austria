...
`;function Be(e){const t=e.electricityType??[];return t.some(e=>"DC"===e||e?.startsWith("DC"))?"dc":t.some(e=>e?.startsWith("AC"))?"ac":null}function He(e){return(e??"").toUpperCase().replace(/_/g,"")}function Ve(e){const t=He(e);return"AVAILABLE"===t?"ok":"CHARGING"===t||"OCCUPIED"===t||"RESERVED"===t||"BLOCKED"===t?"busy":"OUTOFORDER"===t||"FAULTED"===t||"INOPERATIVE"===t||"UNAVAILABLE"===t?"warn":"UNKNOWN"===t?"unknown":"empty"}function We(e){if(!e)return"";const t={AVAILABLE:"available",CHARGING:"charging",OCCUPIED:"occupied",RESERVED:"reserved",BLOCKED:"blocked",OUTOFORDER:"fault",FAULTED:"fault",INOPERATIVE:"fault",UNAVAILABLE:"unavailable",UNKNOWN:"unknown",PLANNED:"planned",REMOVED:"removed"}[He(e)];if(!t)return e;const i=`card.point_status_${t}`,n=Ue(i);return n===i?e:n}function je(e){if(null==e||!Number.isFinite(e))return"–";try{return new Intl.NumberFormat("de-AT",{minimumFractionDigits:0,maximumFractionDigits:1}).format(e)}catch{return String(e).replace(".",",")}}function Ke(e){const t=e/100;try{return new Intl.NumberFormat("de-AT",{minimumFractionDigits:2,maximumFractionDigits:2}).format(t)}catch{return t.toFixed(2)}}function qe(e){if(!Number.isFinite(e))return"0";try{return new Intl.NumberFormat("de-AT",{minimumFractionDigits:0,maximumFractionDigits:2}).format(e)}catch{return String(e).replace(".",",")}}function Ge(e,t){switch(e){case"TYPE_2_AC":return"Type 2";case"COMBO2_CCS_DC":return"CCS";case"CHADEMO":return"CHAdeMO";case"TYPE_1_AC":return"Type 1";case"TESLA_S":case"TESLA_R":return"Tesla";case"OTHER":return"DOMESTIC_F"===t?"Schuko":t?.startsWith("CEE")?"CEE":t??"?";default:return e?.replace(/_/g," ")??t??"?"}}function Ye(e){const t=(e.connectorType??[])[0];return t?Ge(t.consumerName,t.key):"–"}const Ze=["Type 2","CCS","CHAdeMO","Type 1","Tesla","Schuko","CEE"],Je=[{key:"green_energy",icon:"mdi:leaf",label_key:"amenities.green_energy"},{key:"austrian_ecolabel",icon:"mdi:certificate-outline",label_key:"amenities.austrian_ecolabel"},{key:"free_parking",icon:"mdi:parking",label_key:"amenities.free_parking"},{key:"roofed_parking",icon:"mdi:home-roof",label_key:"amenities.roofed_parking"},{key:"illuminated_parking",icon:"mdi:lightbulb-outline",label_key:"amenities.illuminated_parking"},{key:"barrier_free",icon:"mdi:wheelchair-accessibility",label_key:"amenities.barrier_free"},{key:"catering",icon:"mdi:silverware-fork-knife",label_key:"amenities.catering"},{key:"bathrooms",icon:"mdi:toilet",label_key:"amenities.bathrooms"},{key:"resting",icon:"mdi:sofa",label_key:"amenities.resting"}],Qe=[{key:"APP",icon:"mdi:cellphone",label_key:"auth.app"},{key:"QR",icon:"mdi:qrcode",label_key:"auth.qr"},{key:"RFID_READER",icon:"mdi:credit-card-wireless-outline",label_key:"auth.rfid"},{key:"CHARGING_CONTRACT",icon:"mdi:handshake-outline",label_key:"auth.contract"},{key:"DEBIT_CARD",icon:"mdi:credit-card-outline",label_key:"auth.debit"},{key:"CREDIT_CARD",icon:"mdi:credit-card",label_key:"auth.credit"},{key:"CONTACTLESS_CARD_SUPPORT",icon:"mdi:contactless-payment",label_key:"auth.contactless"}];let Xe=class extends se{constructor(){super(...arguments),this._config={type:"ladestellen-austria-card"}}setConfig(e){this._config={...e}}render(){Re(this.hass?.language);const e=this._config.connector_types??[],t=this._config.amenities??[],i=this._config.payment_methods??[];return V`
      <div class="editor">
        ...
        <div class="editor-section">
          ...
          <div class="toggle-row">
            <label>${Ue("editor.show_hero")}</label>
            <ha-switch
          ...
          <div class="toggle-row">
            <label>${Ue("editor.show_pricing")}</label>
            <ha-switch
          ...
          <div class="toggle-row">
            <label>${Ue("editor.show_amenities")}</label>
            <ha-switch
          ...
          <div class="toggle-row">
            <label>${Ue("editor.sort_by_power")}</label>
            <ha-switch
          ...
          <div class="toggle-row">
            <label>${Ue("editor.logo_adapt_to_theme")}</label>
            <ha-switch
        ...
        <div class="editor-section">
          ...
          <div class="toggle-row">
            <label>${Ue("editor.only_available")}</label>
            <ha-switch
          ...
          <div class="toggle-row">
            <label>${Ue("editor.only_free")}</label>
            <ha-switch
          ...
          <div class="toggle-row">
            <label>${Ue("editor.only_open")}</label>
            <ha-switch
    ...
    `}_renderHero(e,t,i,n){if(!e)return V`<div class="hero hero--empty">
      ...
      </div>`;const a=this._formatKm(e.distance),r=this._heroCity(e),o=t?this._formatKm(t.distance):a,s=Ue("card.hero_range").replace("{min}",this._formatKm(e.distance)).replace("{max}",o),l=i===n?Ue("card.hero_count").replace("{count}",String(i)):Ue("card.hero_count_filtered").replace("{filtered}",String(i)).replace("{total}",String(n));return V`
      <div class="hero">
    ...
    `}_heroCity(e){return e.city||e.label||""}_renderStation(e,t,i=!1){const n=e.points??[],a=n.some(e=>(e.electricityType??[]).includes("DC")),r=n.reduce((e,t)=>Math.max(e,t.capacityKw??0),0),o=Array.from(new Set(n.flatMap(e=>(e.connectorType??[]).map(e=>Ge(e.consumerName,e.key))))),s=o.slice(0,3),l=o.length-s.length,c=this._priceText(n),d=n.some(e=>e.freeOfCharge),p=n.length,h=n.filter(e=>"AVAILABLE"===He(e.status)).length,u="ACTIVE"===e.stationStatus,g=this.hass?.config?.time_zone??"Europe/Vienna",f=this._isOpenNow(e.openingHours,new Date,g),m=this._statusLevel(t,u,n,f),v=this._expanded.has(e.stationId),_=`https://www.google.com/maps/search/?api=1&query=${e.location.lat},${e.location.lon}`,b=this.config?.show_amenities??!0,y=this.config?.show_pricing??!0,w=["station",v?"expanded":"",i?"pinned":"","inactive"===m?"inactive":""].filter(Boolean).join(" ");return V`
      <li
        class=${w}
      ...
      >
        ...
        ${v?this._renderStationDetail(e,f,b,_):j}
      </li>
