...
`;var Ot,Tt;!function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(Ot||(Ot={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(Tt||(Tt={}));const Mt=(t,e,i,a)=>{a=a||{},i=null==i?{}:i;const s=new Event(e,{bubbles:void 0===a.bubbles||a.bubbles,cancelable:Boolean(a.cancelable),composed:void 0===a.composed||a.composed});return s.detail=i,t.dispatchEvent(s),s},Lt=["Type 2","CCS","CHAdeMO","Type 1","Tesla","Schuko","CEE"];let Ut=class extends ot{constructor(){super(...arguments),this._config={type:"ladestellen-austria-card"}}setConfig(t){this._config={...t}}render(){Ct(this.hass?.language);const t=this._config.connector_types??[];return F`
    ...
    `}_toggleConnector(t){const e=this._config.connector_types??[],i=e.includes(t)?e.filter(e=>e!==t):[...e,t];this._config={...this._config,connector_types:i},Mt(this,"config-changed",{config:this._config})}_valueChanged(t){if(!this._config||!this.hass)return;const e=t.target;if(!e.configValue)return;const i=void 0!==e.checked?e.checked:t.detail?.value??e.value;this._config[e.configValue]!==i&&(this._config={...this._config,[e.configValue]:i},Mt(this,"config-changed",{config:this._config}))}static{this.styles=Pt}};t([pt({attribute:!1})],Ut.prototype,"hass",void 0),t([ut()],Ut.prototype,"_config",void 0),Ut=t([ct("ladestellen-austria-card-editor")],Ut),console.info(`%c  Ladestellen Austria Card  %c  ${St("common.version")} 0.1.0-beta-17  `,"color: white; font-weight: bold; background: #3FA535","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"ladestellen-austria-card",name:"Ladestellen Austria",description:"Nearby EV charging stations, powered by E-Control Austria",preview:!0,documentationURL:"https://github.com/rolandzeiner/ladestellen-austria"});let Nt=class extends ot{constructor(){super(...arguments),this._expanded=new Set}static getConfigElement(){return document.createElement("ladestellen-austria-card-editor")}static getStubConfig(t,e){const i=e.find(t=>t.startsWith("sensor.")&&t.includes("ladestelle"));return{entity:i??""}}setConfig(t){if(!t)throw new Error(St("common.invalid_configuration"));this.config={name:"Ladestellen Austria",max_stations:10,show_hero:!0,show_amenities:!0,show_pricing:!0,sort_by_power:!1,logo_adapt_to_theme:!1,only_available:!1,only_free:!1,connector_types:[],...t}}shouldUpdate(t){if(!this.config)return!1;if(t.has("config")||t.has("_expanded"))return!0;const e=t.get("hass");return!e||!this.config.entity||e.states[this.config.entity]!==this.hass.states[this.config.entity]}getCardSize(){const t=this.config?.max_stations??10;return Math.min(3+Math.ceil(t/3),10)}render(){if(Ct(this.hass?.language),!this.hass||!this.config)return F`<ha-card
      ...
      `;const e=t.attributes.stations??[],i=!0===t.attributes.live_status_available,a=this._filterStations(e),s=a[0],r=this._sortStations(a),n=Math.max(1,this.config.max_stations??10),o=r.slice(0,n),l=o[o.length-1],c=!1!==this.config.show_hero;return F`
      <ha-card>
        ${this._renderHeader()}
    ...
    `}_sortStations(t){return this.config.sort_by_power?[...t].sort((t,e)=>{const i=Math.max(0,...(t.points??[]).map(t=>t.capacityKw??0)),a=Math.max(0,...(e.points??[]).map(t=>t.capacityKw??0));return a!==i?a-i:(t.distance??1/0)-(e.distance??1/0)}):t}_filterStations(t){const e=this.config.only_available??!1,i=this.config.only_free??!1,a=this.config.connector_types??[];return e||i||0!==a.length?t.filter(t=>{if(e){const e="ACTIVE"===t.stationStatus&&(t.points??[]).some(t=>"AVAILABLE"===t.status);if(!e)return!1}if(i){const e=(t.points??[]).some(t=>t.freeOfCharge);if(!e)return!1}if(a.length>0){const e=new Set((t.points??[]).flatMap(t=>(t.connectorType??[]).map(t=>this._shortConnector(t.consumerName,t.key)))),i=a.some(t=>e.has(t));if(!i)return!1}return!0}):t}_renderHeader(){const t=this.config?.name??"Ladestellen Austria",e=!0===this.config?.logo_adapt_to_theme,i=Boolean(this.hass?.themes?.darkMode);return F`
      <div class="header">
        <a
          class="brand-link"
        ...
        >
          <img
            class=${e?"brand-logo adaptive "+(i?"adaptive-dark":"adaptive-light"):"brand-logo"}
    ...
    `}_metricClass(t,e){return t.endsWith(" kW")?e?"metric metric-kw metric-kw--dc":"metric metric-kw":t===St("card.gratis")?"metric metric-free":t.includes("€")?"metric metric-price":"metric metric-plug"}_renderStationDetail(t,e,i,a,s,r,n){const o=this._amenityItems(t),l=a||!s,c=this._address(t);return F`
      <div class="detail">
