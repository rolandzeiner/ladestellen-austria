...
`;var Ot,Pt;!function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(Ot||(Ot={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(Pt||(Pt={}));const zt=(t,e,i,s)=>{s=s||{},i=null==i?{}:i;const n=new Event(e,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed});return n.detail=i,t.dispatchEvent(n),n},Tt=["Type 2","CCS","CHAdeMO","Type 1","Tesla","Schuko","CEE"];let Mt=class extends ot{constructor(){super(...arguments),this._config={type:"ladestellen-austria-card"}}setConfig(t){this._config={...t}}render(){const t=this._config.connector_types??[];return V`
    ...
    `}_renderStation(t,e){const i=t.points??[],s=i.some(t=>(t.electricityType??[]).includes("DC")),n=i.reduce((t,e)=>Math.max(t,e.capacityKw??0),0),r=Array.from(new Set(i.flatMap(t=>(t.connectorType??[]).map(t=>this._shortConnector(t.consumerName,t.key))))),a=this._priceText(i),o=i.some(t=>t.freeOfCharge),l=i.length,c=i.filter(t=>"AVAILABLE"===t.status).length,d="ACTIVE"===t.stationStatus,h=this._expanded.has(t.stationId),p=this._address(t),u=this._amenityItems(t),f=this.config?.show_amenities??!0,m=this.config?.show_pricing??!0;return V`
      ...
      >
        ...
        ${h?this._renderStationDetail(t,p,u,f,e,d,c,l):K}
      </li>
    `}_renderStationDetail(t,e,i,s,n,r,a,o){const l=this._statusLine(n,r,a,o),c=`https://www.google.com/maps/search/?api=1&query=${t.location.lat},${t.location.lon}`;return V`
      <div class="detail">
        ${e?V`<div class="station-address">${e}</div>`:K}
        ${l}
        ${s&&i.length>0?V`<div class="amenities">
              ${i.map(t=>V`
                  <span
