...
`,Ye=[je,Ve,We,Ke],Ze=[je,Ve,We,Ge];function Qe(e){const t=e.electricityType??[];return t.some(e=>"DC"===e||e?.startsWith("DC"))?"dc":t.some(e=>e?.startsWith("AC"))?"ac":null}function Je(e){return(e??"").toUpperCase().replace(/_/g,"")}function Xe(e){const t=Je(e);return"AVAILABLE"===t?"ok":"CHARGING"===t||"OCCUPIED"===t||"RESERVED"===t||"BLOCKED"===t?"busy":"OUTOFORDER"===t||"FAULTED"===t||"INOPERATIVE"===t||"UNAVAILABLE"===t?"warn":"UNKNOWN"===t?"unknown":"empty"}function et(e){if(!e)return"";const t={AVAILABLE:"available",CHARGING:"charging",OCCUPIED:"occupied",RESERVED:"reserved",BLOCKED:"blocked",OUTOFORDER:"out_of_order",FAULTED:"faulted",INOPERATIVE:"inoperative",UNAVAILABLE:"unavailable",OUTOFSTOCK:"out_of_stock",PLANNED:"planned",REMOVED:"removed",UNKNOWN:"unknown"}[Je(e)];if(!t)return e;const i=`card.point_status_${t}`,n=Me(i);return n===i?e:n}function tt(e){const t=Xe(e.status),i=function(e){switch(Je(e)){case"OUTOFORDER":case"FAULTED":case"INOPERATIVE":case"UNAVAILABLE":return{icon:"mdi:wrench",tone:"warning"};case"OUTOFSTOCK":return{icon:"mdi:battery-off-outline",tone:"warning",bgTint:"warning"};case"PLANNED":return{icon:"mdi:progress-wrench",tone:"info",bgTint:"info"};case"REMOVED":return{icon:"mdi:close-circle-outline",tone:"error",bgTint:"error"};case"UNKNOWN":return{icon:"mdi:help-circle-outline",tone:"muted"};default:return null}}(e.status);return{bucket:t,isAvailable:"ok"===t,isBusy:"busy"===t,isWarn:"warn"===t,overlay:i,showCar:"busy"===t&&null===i,showOverlayIcon:null!==i}}function it(e){if(null==e||!Number.isFinite(e))return"–";try{return new Intl.NumberFormat("de-AT",{minimumFractionDigits:0,maximumFractionDigits:1}).format(e)}catch{return String(e).replace(".",",")}}function nt(e){const t=e/100;try{return new Intl.NumberFormat("de-AT",{minimumFractionDigits:2,maximumFractionDigits:2}).format(t)}catch{return t.toFixed(2)}}function at(e){if(!Number.isFinite(e))return"0";try{return new Intl.NumberFormat("de-AT",{minimumFractionDigits:0,maximumFractionDigits:2}).format(e)}catch{return String(e).replace(".",",")}}function rt(e,t){switch(e){case"TYPE_2_AC":return"Type 2";case"COMBO2_CCS_DC":return"CCS";case"CHADEMO":return"CHAdeMO";case"TYPE_1_AC":return"Type 1";case"TESLA_S":case"TESLA_R":return"Tesla";case"OTHER":return"DOMESTIC_F"===t?"Schuko":t?.startsWith("CEE")?"CEE":t??"?";default:return e?.replace(/_/g," ")??t??"?"}}function ot(e){const t=(e.connectorType??[])[0];return t?rt(t.consumerName,t.key):"–"}const st=[{name:"entity",required:!0,selector:{entity:{domain:"sensor",integration:"ladestellen_austria"}}},{name:"name",selector:{text:{}}},{type:"expandable",name:"display",flatten:!0,schema:[{name:"max_stations",selector:{number:{min:1,max:10,step:1,mode:"slider"}}},{name:"hide_header",selector:{boolean:{}}},{name:"show_hero",selector:{boolean:{}}},{name:"show_pricing",selector:{boolean:{}}},{name:"show_amenities",selector:{boolean:{}}},{name:"sort_by_power",selector:{boolean:{}}},{name:"logo_adapt_to_theme",selector:{boolean:{}}}]},{type:"expandable",name:"filters",flatten:!0,schema:[{name:"only_available",selector:{boolean:{}}},{name:"only_free",selector:{boolean:{}}},{name:"only_open",selector:{boolean:{}}}]}],lt={max_stations:10,hide_header:!1,show_hero:!0,show_pricing:!0,show_amenities:!0,sort_by_power:!1,logo_adapt_to_theme:!1,only_available:!1,only_free:!1,only_open:!1};let ct=class extends se{constructor(){super(...arguments),this._config={type:"ladestellen-austria-card"},this._computeLabel=e=>{const t="expandable"===e.type?`editor.section_${e.name}`:`editor.${e.name}`,i=Me(t);return i===t?e.name:i}}setConfig(e){const t=e.entity&&this.hass?.states[e.entity]?.attributes.friendly_name;this._config="string"==typeof t?{name:t,...e}:{...e}}_formChanged(e){const t=e.detail.value;t&&(this._config=t,ge(this,"config-changed",{config:t}))}_toggleConnector(e){const t=this._config.connector_types??[],i=t.includes(e)?t.filter(t=>t!==e):[...t,e];this._config={...this._config,connector_types:i},ge(this,"config-changed",{config:this._config})}_toggleAmenity(e){const t=this._config.amenities??[],i=t.includes(e)?t.filter(t=>t!==e):[...t,e];this._config={...this._config,amenities:i},ge(this,"config-changed",{config:this._config})}_togglePayment(e){const t=this._config.payment_methods??[],i=t.includes(e)?t.filter(t=>t!==e):[...t,e];this._config={...this._config,payment_methods:i},ge(this,"config-changed",{config:this._config})}_togglePin(e){const t=this._config.pinned_station_ids??[],i=t.includes(e)?t.filter(t=>t!==e):[...t,e];this._config={...this._config,pinned_station_ids:i},ge(this,"config-changed",{config:this._config})}willUpdate(e){super.willUpdate(e),e.has("hass")&&Ue(this.hass?.language)}render(){if(!this.hass)return j`<p>${Me("common.loading")}</p>`;const e={...lt,...this._config},t=this._config.connector_types??[],i=this._config.amenities??[],n=this._config.payment_methods??[],a=!!this._config.entity&&!this.hass.states[this._config.entity];return j`
    ...
    `}static{this.styles=qe}};e([he({attribute:!1})],ct.prototype,"hass",void 0),e([ue()],ct.prototype,"_config",void 0),ct=e([ce("ladestellen-austria-card-editor")],ct);const dt={hide_header:!1,show_free_count:!0,logo_adapt_to_theme:!1,car_color_mode:"random"},pt=[{name:"entity",required:!0,selector:{entity:{domain:"sensor",integration:"ladestellen_austria"}}},{name:"name",selector:{text:{}}}],ht=[{type:"expandable",name:"appearance",flatten:!0,schema:[{name:"hide_header",selector:{boolean:{}}},{name:"show_free_count",selector:{boolean:{}}},{name:"logo_adapt_to_theme",selector:{boolean:{}}},{name:"car_color_mode",selector:{select:{mode:"dropdown",options:[{value:"random",label:Me("editor.car_color_random")},{value:"theme",label:Me("editor.car_color_theme")},{value:"fixed",label:Me("editor.car_color_fixed")}]}}}]}];let ut=class extends se{constructor(){super(...arguments),this._config={type:"ladestellen-austria-parking-card"},this._computeLabel=e=>{const t="expandable"===e.type?`editor.section_${e.name}`:`editor.${e.name}`,i=Me(t);return i===t?e.name:i}}setConfig(e){this._config={...e}}_formChanged(e){const t=e.detail.value;t&&(this._config=t,ge(this,"config-changed",{config:t}))}_selectStation(e){const t=this._config.station_id===e?"":e;this._config={...this._config,station_id:t},ge(this,"config-changed",{config:this._config})}_carColorFixedChanged(e){const t=e.target;if(!t)return;const i=t.value;this._config.car_color_fixed!==i&&(this._config={...this._config,car_color_fixed:i},ge(this,"config-changed",{config:this._config}))}willUpdate(e){super.willUpdate(e),e.has("hass")&&Ue(this.hass?.language)}render(){if(!this.hass)return j`<p>${Me("common.loading")}</p>`;const e=this._config.entity,t=e?this.hass.states[e]:void 0,i=t?.attributes?.stations??[],n=this._config.station_id??"",a={...dt,...this._config},r=!!e&&!this.hass.states[e];return j`
      <div class="editor">
        <ha-form
          .hass=${this.hass}
          .data=${a}
