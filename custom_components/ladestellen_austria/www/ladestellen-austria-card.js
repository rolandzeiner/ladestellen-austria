...
`;function He(e){const t=e.electricityType??[];return t.some(e=>"DC"===e||e?.startsWith("DC"))?"dc":t.some(e=>e?.startsWith("AC"))?"ac":null}function Be(e){return(e??"").toUpperCase().replace(/_/g,"")}function Ve(e){const t=Be(e);return"AVAILABLE"===t?"ok":"CHARGING"===t||"OCCUPIED"===t||"RESERVED"===t||"BLOCKED"===t?"busy":"OUTOFORDER"===t||"FAULTED"===t||"INOPERATIVE"===t||"UNAVAILABLE"===t?"warn":"UNKNOWN"===t?"unknown":"empty"}function je(e){if(!e)return"";const t={AVAILABLE:"available",CHARGING:"charging",OCCUPIED:"occupied",RESERVED:"reserved",BLOCKED:"blocked",OUTOFORDER:"out_of_order",FAULTED:"faulted",INOPERATIVE:"inoperative",UNAVAILABLE:"unavailable",OUTOFSTOCK:"out_of_stock",PLANNED:"planned",REMOVED:"removed",UNKNOWN:"unknown"}[Be(e)];if(!t)return e;const i=`card.point_status_${t}`,a=Ue(i);return a===i?e:a}function We(e){switch(Be(e)){case"OUTOFORDER":case"FAULTED":case"INOPERATIVE":case"UNAVAILABLE":return{icon:"mdi:wrench",tone:"warning"};case"OUTOFSTOCK":return{icon:"mdi:battery-off-outline",tone:"warning",bgTint:"warning"};case"PLANNED":return{icon:"mdi:progress-wrench",tone:"info",bgTint:"info"};case"REMOVED":return{icon:"mdi:close-circle-outline",tone:"error",bgTint:"error"};case"UNKNOWN":return{icon:"mdi:help-circle-outline",tone:"muted"};default:return null}}function Ke(e){if(null==e||!Number.isFinite(e))return"–";try{return new Intl.NumberFormat("de-AT",{minimumFractionDigits:0,maximumFractionDigits:1}).format(e)}catch{return String(e).replace(".",",")}}function qe(e){const t=e/100;try{return new Intl.NumberFormat("de-AT",{minimumFractionDigits:2,maximumFractionDigits:2}).format(t)}catch{return t.toFixed(2)}}function Ge(e){if(!Number.isFinite(e))return"0";try{return new Intl.NumberFormat("de-AT",{minimumFractionDigits:0,maximumFractionDigits:2}).format(e)}catch{return String(e).replace(".",",")}}function Ye(e,t){switch(e){case"TYPE_2_AC":return"Type 2";case"COMBO2_CCS_DC":return"CCS";case"CHADEMO":return"CHAdeMO";case"TYPE_1_AC":return"Type 1";case"TESLA_S":case"TESLA_R":return"Tesla";case"OTHER":return"DOMESTIC_F"===t?"Schuko":t?.startsWith("CEE")?"CEE":t??"?";default:return e?.replace(/_/g," ")??t??"?"}}function Ze(e){const t=(e.connectorType??[])[0];return t?Ye(t.consumerName,t.key):"–"}const Qe=["Type 2","CCS","CHAdeMO","Type 1","Tesla","Schuko","CEE"],Je=[{key:"green_energy",icon:"mdi:leaf",label_key:"amenities.green_energy"},{key:"austrian_ecolabel",icon:"mdi:certificate-outline",label_key:"amenities.austrian_ecolabel"},{key:"free_parking",icon:"mdi:parking",label_key:"amenities.free_parking"},{key:"roofed_parking",icon:"mdi:home-roof",label_key:"amenities.roofed_parking"},{key:"illuminated_parking",icon:"mdi:lightbulb-outline",label_key:"amenities.illuminated_parking"},{key:"barrier_free",icon:"mdi:wheelchair-accessibility",label_key:"amenities.barrier_free"},{key:"catering",icon:"mdi:silverware-fork-knife",label_key:"amenities.catering"},{key:"bathrooms",icon:"mdi:toilet",label_key:"amenities.bathrooms"},{key:"resting",icon:"mdi:sofa",label_key:"amenities.resting"}],Xe=[{key:"APP",icon:"mdi:cellphone",label_key:"auth.app"},{key:"QR",icon:"mdi:qrcode",label_key:"auth.qr"},{key:"RFID_READER",icon:"mdi:credit-card-wireless-outline",label_key:"auth.rfid"},{key:"CHARGING_CONTRACT",icon:"mdi:handshake-outline",label_key:"auth.contract"},{key:"DEBIT_CARD",icon:"mdi:credit-card-outline",label_key:"auth.debit"},{key:"CREDIT_CARD",icon:"mdi:credit-card",label_key:"auth.credit"},{key:"CONTACTLESS_CARD_SUPPORT",icon:"mdi:contactless-payment",label_key:"auth.contactless"}];let et=class extends se{constructor(){super(...arguments),this._config={type:"ladestellen-austria-card"}}setConfig(e){const t=e.entity&&this.hass?.states[e.entity]?.attributes.friendly_name;this._config={name:"string"==typeof t?t:void 0,...e}}render(){Ne(this.hass?.language);const e=this._config.connector_types??[],t=this._config.amenities??[],i=this._config.payment_methods??[],a=!!this._config.entity&&!!this.hass&&!this.hass.states[this._config.entity];return V`
        ...
        <div class="editor-section">
          ...
          <div class="toggle-row">
            <label for="toggle-hide-header"
              >${Ue("editor.hide_header")}</label
            >
            <ha-switch
              id="toggle-hide-header"
              .checked=${this._config.hide_header??!1}
    ...
    `}_renderPinSection(){const e=this._config.entity,t=e?this.hass?.states[e]:void 0,i=t?.attributes?.stations??[],a=this._config.pinned_station_ids??[],n=new Set(a),o=new Set(i.map(e=>e.stationId)),r=a.filter(e=>!o.has(e)),s=!0===t?.attributes?.dynamic_mode;return V`
      <div class="editor-section">
    ...
    `}_selectStation(e){const t=this._config.station_id===e?"":e;this._config={...this._config,station_id:t},me(this,"config-changed",{config:this._config})}_valueChanged(e){if(!this._config||!this.hass)return;const t=e.target;if(!t.configValue)return;const i="HA-SWITCH"===(t.tagName??"").toUpperCase()||"checkbox"===t.type?Boolean(t.checked):e.detail?.value??t.value;this._config[t.configValue]!==i&&(this._config={...this._config,[t.configValue]:i},me(this,"config-changed",{config:this._config}))}static{this.styles=Fe}};e([pe({attribute:!1})],tt.prototype,"hass",void 0),e([ue()],tt.prototype,"_config",void 0),tt=e([ce("ladestellen-austria-parking-card-editor")],tt);window.customCards=window.customCards||[],window.customCards.push({type:"ladestellen-austria-parking-card",name:"Ladestellen Austria — Parking",description:"Single station, points rendered as parking slots viewed from above.",preview:!0,documentationURL:"https://github.com/rolandzeiner/ladestellen-austria"});let it=class extends se{constructor(){super(...arguments),this._revealedSlots=new Set}static getConfigElement(){return document.createElement("ladestellen-austria-parking-card-editor")}static getStubConfig(e,t){const i=t.find(e=>e.startsWith("sensor.")&&e.includes("ladestelle"));return{entity:i??"",station_id:""}}setConfig(e){if(!e)throw new Error(Ue("common.invalid_configuration"));this.config={...e}}shouldUpdate(e){if(!this.config)return!1;if(e.has("config")||e.has("_revealedSlots"))return!0;const t=e.get("hass");return!t||!this.config.entity||t.states[this.config.entity]!==this.hass.states[this.config.entity]}getCardSize(){return 3}getGridOptions(){return{columns:6,rows:"auto",min_columns:4,min_rows:3}}render(){if(Ne(this.hass?.language),!this.hass||!this.config)return V`<ha-card>
        ...
        <div class="card-content">
          <div class="wrap">
            ${n&&!this.config.hide_header?V`<header class="header">
      ...
      </ha-card>`;const o=(a.points??[]).slice().sort((e,t)=>{const i=parseInt((e.evseId??"").split("*").pop()??"",10),a=parseInt((t.evseId??"").split("*").pop()??"",10);return Number.isFinite(i)&&Number.isFinite(a)?i-a:(e.evseId??"").localeCompare(t.evseId??"")}),r=o.filter(e=>"ok"===Ve(e.status)).length,s=o.length,l=Ue("parking.available_count").replace("{avail}",String(r)).replace("{total}",String(s)),c=n??a.label,d=n?a.label:"";return V`
      <ha-card>
        <div class="card-content">
          <div
            class="wrap"
          ...
          >
            ${this.config.hide_header?W:V`<header class="header">
                  <div class="icon-tile" aria-hidden="true">
                    <ha-icon icon="mdi:ev-station"></ha-icon>
                  </div>
                  <div class="header-text">
    ...
    `}_renderSlot(e){const t=Ve(e.status),i=He(e),a=Ze(e),n=Ke(e.capacityKw),o=je(e.status),r=this._slotStatusBucket(t),s={AVAILABLE:"free",CHARGING:"busy",OCCUPIED:"busy",RESERVED:"reserved",BLOCKED:"blocked",OUTOFORDER:"out_of_order",FAULTED:"faulted",INOPERATIVE:"inoperative",UNAVAILABLE:"unavailable",OUTOFSTOCK:"out_of_stock",PLANNED:"planned",REMOVED:"removed",UNKNOWN:"unknown"}[Be(e.status)]??"unknown";const l="ok"===t,c="busy"===t,d="warn"===t,h=We(e.status),p=c&&!h,u=null!==h,g=p||u,f=g&&this._revealedSlots.has(e.evseId),m=l?"is-available":c?"is-busy":d?"is-warn":"is-unknown",v=[i?i.toUpperCase():null,e.capacityKw?`${n} kW`:null,a&&"–"!==a?a:null,o].filter(Boolean).join(" · "),_=p?this._carColor(e.evseId):null,b=["parking-slot",m,g?"has-overlay":"",p?"has-car":"",u?"has-icon":"",h?.bgTint?`slot-tint-${h.bgTint}`:"",f?"is-revealed":""].filter(Boolean).join(" ");return V`
      <button
        type="button"
        class=${b}
        data-status=${t}
      ...
      >
        ${p&&_?V`<span class="slot-car" aria-hidden="true">
              ${this._renderCarSvg(_)}
            </span>`:W}
        ${h?V`<span
              class="slot-overlay-icon tone-${h.tone}"
              aria-hidden="true"
            >
    ...
    `}static{this.styles=Me}};e([pe({attribute:!1})],it.prototype,"hass",void 0),e([ue()],it.prototype,"config",void 0),e([ue()],it.prototype,"_revealedSlots",void 0),it=e([ce("ladestellen-austria-parking-card")],it),console.info(`%c  Ladestellen Austria Card  %c  ${Ue("common.version")} 0.2.2  `,"color: white; font-weight: bold; background: #3FA535","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"ladestellen-austria-card",name:"Ladestellen Austria",description:"Nearby EV charging stations, powered by E-Control Austria",preview:!0,documentationURL:"https://github.com/rolandzeiner/ladestellen-austria"});const at={MONDAY:0,TUESDAY:1,WEDNESDAY:2,THURSDAY:3,FRIDAY:4,SATURDAY:5,SUNDAY:6},nt={Mon:0,Tue:1,Wed:2,Thu:3,Fri:4,Sat:5,Sun:6};let ot=class extends se{constructor(){super(...arguments),this._expanded=new Set}static getConfigElement(){return document.createElement("ladestellen-austria-card-editor")}static getStubConfig(e,t){const i=t.find(e=>e.startsWith("sensor.")&&e.includes("ladestelle"));return{entity:i??""}}setConfig(e){if(!e)throw new Error(Ue("common.invalid_configuration"));this.config={name:"Ladestellen Austria",max_stations:10,show_hero:!0,show_amenities:!0,show_pricing:!0,sort_by_power:!1,logo_adapt_to_theme:!1,only_available:!1,only_free:!1,only_open:!1,connector_types:[],amenities:[],payment_methods:[],pinned_station_ids:[],...e}}shouldUpdate(e){if(!this.config)return!1;if(e.has("config")||e.has("_expanded"))return!0;const t=e.get("hass");return!t||!this.config.entity||t.states[this.config.entity]!==this.hass.states[this.config.entity]}getCardSize(){const e=this.config?.max_stations??10;return Math.min(3+Math.ceil(e/3),10)}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:3}}render(){if(Ne(this.hass?.language),!this.hass||!this.config)return V`<ha-card>
      ...
      `;const t=e.attributes.stations??[],i=!0===e.attributes.live_status_available,a=!0===e.attributes.dynamic_mode,n=e.attributes.dynamic_entity??null,o=a?[]:this.config.pinned_station_ids??[],r=this._collectPinnedItems(o,t),s=new Set(r.filter(e=>"live"===e.kind).map(e=>e.stationId)),l=t.filter(e=>!s.has(e.stationId)),c=this._filterStations(l),d=this._sortStations(c),h=t[0],p=Math.max(1,this.config.max_stations??10),u=[...r,...d.map(e=>({kind:"live",station:e}))],g=u.slice(0,p),f=g.filter(e=>"live"===e.kind).map(e=>e.station),m=f.length>0?f[f.length-1]:void 0,v=!1!==this.config.show_hero,_=this.config.name&&this.config.name.trim()?this.config.name:"Ladestellen Austria",b=h?this._heroCity(h):"";return V`
      <ha-card>
        <div class="card-content">
          <div class="wrap">
            ${this.config.hide_header?W:V`<header class="header">
            ...
            ${v?this._renderHero(h,m,c.length,t.length):W}
    ...
    `}_renderHero(e,t,i,a){if(!e)return V`<section class="hero hero--empty" aria-live="polite">
        ${Ue("card.no_stations")}
      </section>`;const n=this._formatKm(e.distance),o=this._heroCity(e),r=t?this._formatKm(t.distance):n,s=Ue("card.hero_range").replace("{min}",this._formatKm(e.distance)).replace("{max}",r),l=i===a?Ue("card.hero_count").replace("{count}",String(i)):Ue("card.hero_count_filtered").replace("{filtered}",String(i)).replace("{total}",String(a));return V`
    ...
    `}_heroCity(e){return e.city||e.label||""}_renderStation(e,t,i=!1){const a=e.points??[],n=a.some(e=>(e.electricityType??[]).includes("DC")),o=a.reduce((e,t)=>Math.max(e,t.capacityKw??0),0),r=Array.from(new Set(a.flatMap(e=>(e.connectorType??[]).map(e=>Ye(e.consumerName,e.key))))),s=r.slice(0,3),l=r.length-s.length,c=this._priceText(a),d=a.some(e=>e.freeOfCharge),h=a.length,p=a.filter(e=>"AVAILABLE"===Be(e.status)).length,u="ACTIVE"===e.stationStatus,g=this.hass?.config?.time_zone??"Europe/Vienna",f=this._isOpenNow(e.openingHours,new Date,g),m=this._statusLevel(t,u,a,f),v=this._expanded.has(e.stationId),_=`https://www.google.com/maps/search/?api=1&query=${e.location.lat},${e.location.lon}`,b=this.config?.show_amenities??!0,y=this.config?.show_pricing??!0,x=["station",v?"expanded":"",i?"is-pinned":"","inactive"===m?"is-inactive":""].filter(Boolean).join(" "),w=[[e.postCode,e.city].filter(Boolean).join(" "),Number.isFinite(e.distance)?`${this._formatKm(e.distance)} km`:""].filter(Boolean).join(" · ");return V`
      <li
        class=${x}
      ...
      >
        <div class="station-body">
          <span
            ...
            role="img"
            aria-label=${this._statusAria(m,p,h)}
          ></span>
          <div class="station-main">
            <div class="row-primary">
              ${o>0?V`<span class=${n?"metric-kw dc":"metric-kw"}>
    ...
    `}_renderStationDetail(e,t,i,a){const n=this._amenityItems(e),o=e.points??[],r=this._address(e),s=this._paymentChips(o),l=this._feesLine(o),c=e.operatorName||e.owner||"";return V`
      <div class="detail">
    ...
    `}_renderRackSlot(e){const t=He(e),i=Ve(e.status),a=this._pointTooltip(e),n=this._pointAriaLabel(e,t),o=t?V`<span class="power-badge" data-type=${t}
          >${t.toUpperCase()}</span
        >`:W,r=We(e.status);if(r){const e=r.bgTint?`rack-slot slot-tint-${r.bgTint}`:"rack-slot";return V`
        <div
          class=${e}
          role="group"
          aria-label=${n}
      ...
      `}const s=Ze(e),l=Ke(e.capacityKw);return V`
      <div
        class="rack-slot"
        role="group"
        aria-label=${n}
    ...
    `}_pointAriaLabel(e,t){const i=[];t&&i.push(t.toUpperCase()),e.capacityKw&&i.push(`${Ke(e.capacityKw)} kW`);const a=Ze(e);a&&"–"!==a&&i.push(a);const n=je(e.status);return n&&i.push(n),i.join(" · ")}_pointTooltip(e){const t=[`${e.evseId??""} · ${je(e.status)}`.trim()],i=e.startFeeCent??0;i>0&&t.push(`${Ue("card.start_fee_label")}: ${qe(i)} €`);const a=e.blockingFeeCentMin??0,n=e.blockingFeeFromMinute??0;return a>0&&n>0&&t.push(`${Ge(a)} ${Ue("card.blocking_fee_label").replace("{from}",String(n))}`),t.join("\n")}_renderOpeningHoursSection(e,t){if(!e||0===e.length)return W;const i=this._formatOpeningHours(e);if(0===i.length)return W;const a=!0===t?"flag ok":!1===t?"flag warn":null,n=!0===t?"mdi:clock-check-outline":!1===t?"mdi:clock-alert-outline":null,o=!0===t?Ue("card.open_now"):!1===t?Ue("card.closed_now"):null;return V`
