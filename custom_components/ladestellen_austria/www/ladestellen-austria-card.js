...
`,Me=["Type 2","CCS","CHAdeMO","Type 1","Tesla","Schuko","CEE"];let Ie=class extends se{constructor(){super(...arguments),this._config={type:"ladestellen-austria-card"}}setConfig(e){this._config={...e}}render(){Ne(this.hass?.language);const e=this._config.connector_types??[];return B`
      <div class="editor">
        <div class="editor-section">
          <div class="section-header">${Le("editor.section_main")}</div>
          ...
          ${this.hass?B`
                ...
                ></ha-selector>
              `:B`<p>${Le("common.loading")}</p>`}

          <ha-textfield
            label=${Le("editor.name")}
        ...
        <div class="editor-section">
          <div class="section-header">${Le("editor.section_display")}</div>
          ...
          ${this.hass?B`
                <ha-selector
                  ...
                  .label=${Le("editor.max_stations")}
                  @value-changed=${this._valueChanged}
                ></ha-selector>
              `:j}

          <div class="toggle-row">
            <label>${Le("editor.show_hero")}</label>
            <ha-switch
          ...
          <div class="toggle-row">
            <label>${Le("editor.show_pricing")}</label>
            <ha-switch
          ...
          <div class="toggle-row">
            <label>${Le("editor.show_amenities")}</label>
            <ha-switch
          ...
          <div class="toggle-row">
            <label>${Le("editor.sort_by_power")}</label>
            <ha-switch
          ...
          <div class="toggle-row">
            <label>${Le("editor.logo_adapt_to_theme")}</label>
            <ha-switch
        ...
        <div class="editor-section">
          <div class="section-header">${Le("editor.section_filters")}</div>

          <div class="toggle-row">
            <label>${Le("editor.only_available")}</label>
            <ha-switch
          ...
          <div class="toggle-row">
            <label>${Le("editor.only_free")}</label>
            <ha-switch
          ...
          <div class="editor-hint">${Le("editor.connector_filter_hint")}</div>
          <div class="chip-row">
            ${Me.map(t=>B`
                <button
                  type="button"
    ...
    `}_togglePin(e){const t=this._config.pinned_station_ids??[],i=t.includes(e)?t.filter(t=>t!==e):[...t,e];this._config={...this._config,pinned_station_ids:i},fe(this,"config-changed",{config:this._config})}_toggleConnector(e){const t=this._config.connector_types??[],i=t.includes(e)?t.filter(t=>t!==e):[...t,e];this._config={...this._config,connector_types:i},fe(this,"config-changed",{config:this._config})}_valueChanged(e){if(!this._config||!this.hass)return;const t=e.target;if(!t.configValue)return;const i=void 0!==t.checked?t.checked:e.detail?.value??t.value;this._config[t.configValue]!==i&&(this._config={...this._config,[t.configValue]:i},fe(this,"config-changed",{config:this._config}))}static{this.styles=Ue}};e([he({attribute:!1})],Ie.prototype,"hass",void 0),e([ue()],Ie.prototype,"_config",void 0),Ie=e([ce("ladestellen-austria-card-editor")],Ie),console.info(`%c  Ladestellen Austria Card  %c  ${Le("common.version")} 0.1.0-beta-46  `,"color: white; font-weight: bold; background: #3FA535","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"ladestellen-austria-card",name:"Ladestellen Austria",description:"Nearby EV charging stations, powered by E-Control Austria",preview:!0,documentationURL:"https://github.com/rolandzeiner/ladestellen-austria"});const Fe={MONDAY:0,TUESDAY:1,WEDNESDAY:2,THURSDAY:3,FRIDAY:4,SATURDAY:5,SUNDAY:6},He={Mon:0,Tue:1,Wed:2,Thu:3,Fri:4,Sat:5,Sun:6};let Ve=class extends se{constructor(){super(...arguments),this._expanded=new Set}static getConfigElement(){return document.createElement("ladestellen-austria-card-editor")}static getStubConfig(e,t){const i=t.find(e=>e.startsWith("sensor.")&&e.includes("ladestelle"));return{entity:i??""}}setConfig(e){if(!e)throw new Error(Le("common.invalid_configuration"));this.config={name:"Ladestellen Austria",max_stations:10,show_hero:!0,show_amenities:!0,show_pricing:!0,sort_by_power:!1,logo_adapt_to_theme:!1,only_available:!1,only_free:!1,connector_types:[],pinned_station_ids:[],...e}}shouldUpdate(e){if(!this.config)return!1;if(e.has("config")||e.has("_expanded"))return!0;const t=e.get("hass");return!t||!this.config.entity||t.states[this.config.entity]!==this.hass.states[this.config.entity]}getCardSize(){const e=this.config?.max_stations??10;return Math.min(3+Math.ceil(e/3),10)}render(){if(Ne(this.hass?.language),!this.hass||!this.config)return B`<ha-card
      ...
      <ha-card>
        ${f?B`<div class="custom-title">${f}</div>`:j}
        ${m?this._renderHero(c,g,s.length,t.length):j}
    ...
    `}_renderHero(e,t,i,n){if(!e)return B`<div class="hero hero--empty">
        <div class="hero-label">${Le("card.no_stations")}</div>
      </div>`;const a=this._formatKm(e.distance),r=this._heroCity(e),o=t?this._formatKm(t.distance):a,s=Le("card.hero_range").replace("{min}",this._formatKm(e.distance)).replace("{max}",o),l=i===n?Le("card.hero_count").replace("{count}",String(i)):Le("card.hero_count_filtered").replace("{filtered}",String(i)).replace("{total}",String(n));return B`
      <div class="hero">
        ...
        <div class="hero-context">
          <div class="hero-context-1">
            ${Le("card.hero_context").replace("{city}",r)}
          </div>
          <div class="hero-context-2">${l} · ${s}</div>
        </div>
      </div>
    `}_heroCity(e){return e.city||e.label||""}_renderStation(e,t,i=!1){const n=e.points??[],a=n.some(e=>(e.electricityType??[]).includes("DC")),r=n.reduce((e,t)=>Math.max(e,t.capacityKw??0),0),o=Array.from(new Set(n.flatMap(e=>(e.connectorType??[]).map(e=>this._shortConnector(e.consumerName,e.key))))),s=o.slice(0,3),l=o.length-s.length,c=this._priceText(n),d=n.some(e=>e.freeOfCharge),p=n.length,h=n.filter(e=>"AVAILABLE"===this._normStatus(e.status)).length,u="ACTIVE"===e.stationStatus,g=this.hass?.config?.time_zone??"Europe/Vienna",m=this._isOpenNow(e.openingHours,new Date,g),f=this._statusLevel(t,u,n,m),v=this._expanded.has(e.stationId),_=`https://www.google.com/maps/search/?api=1&query=${e.location.lat},${e.location.lon}`,b=this.config?.show_amenities??!0,y=this.config?.show_pricing??!0,w=["station",v?"expanded":"",i?"pinned":"","inactive"===f?"inactive":""].filter(Boolean).join(" ");return B`
      <li
        class=${w}
          ...
          <div class="station-grid">
            <span class="station-metrics">
              ${i?B`<ha-icon
                    class="pin-indicator"
                    icon="mdi:pin"
                    title=${Le("card.pinned")}
                    aria-label=${Le("card.pinned")}
                  ></ha-icon>`:j}
              ${r>0?B`<span
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label=${Le("card.open_in_maps")}
    ...
    `}_renderStationDetail(e,t,i,n){const a=this._amenityItems(e),r=e.points??[],o=this._address(e),s=this._paymentChips(r),l=this._feesLine(r),c=e.operatorName||e.owner||"";return B`
      <div class="detail">
        ...
        ${r.length>0?B`<div class="detail-section">
              ...
              ${this._renderRack(r)}
              ${l?B`<div class="fees-line">${l}</div>`:j}
            </div>`:j}
    ...
    `}_renderRackSlot(e){const t=this._pointPowerType(e),i=this._rackSlotStatus(e.status),n=this._pointTooltip(e),a=this._pointAriaLabel(e,t),r=t?B`<span class="power-badge" data-type=${t}
          >${t.toUpperCase()}</span
        >`:j;if("warn"===i)return B`
        <div
          class="rack-slot"
          role="group"
          aria-label=${a}
      ...
      `;const o=this._pointConnectorLabel(e),s=this._formatKw(e.capacityKw);return B`
      <div
        class="rack-slot"
        role="group"
        aria-label=${a}
    ...
    `}_pointAriaLabel(e,t){const i=[];t&&i.push(t.toUpperCase()),e.capacityKw&&i.push(`${this._formatKw(e.capacityKw)} kW`);const n=this._pointConnectorLabel(e);n&&"–"!==n&&i.push(n);const a=this._pointStatusLabel(e.status);return a&&i.push(a),i.join(" · ")}_pointPowerType(e){const t=e.electricityType??[];return t.some(e=>"DC"===e||e?.startsWith("DC"))?"dc":t.some(e=>e?.startsWith("AC"))?"ac":null}_normStatus(e){return(e??"").toUpperCase().replace(/_/g,"")}_rackSlotStatus(e){const t=this._normStatus(e);return"AVAILABLE"===t?"ok":"CHARGING"===t||"OCCUPIED"===t||"RESERVED"===t||"BLOCKED"===t?"busy":"OUTOFORDER"===t||"FAULTED"===t||"INOPERATIVE"===t||"UNAVAILABLE"===t?"warn":"UNKNOWN"===t?"unknown":"empty"}_pointConnectorLabel(e){const t=(e.connectorType??[])[0];return t?this._shortConnector(t.consumerName,t.key):"–"}_formatKw(e){if(null==e||!Number.isFinite(e))return"–";try{return new Intl.NumberFormat("de-AT",{minimumFractionDigits:0,maximumFractionDigits:1}).format(e)}catch{return String(e).replace(".",",")}}_formatCent(e){if(!Number.isFinite(e))return"0";try{return new Intl.NumberFormat("de-AT",{minimumFractionDigits:0,maximumFractionDigits:2}).format(e)}catch{return String(e).replace(".",",")}}_pointTooltip(e){const t=[`${e.evseId??""} · ${this._pointStatusLabel(e.status)}`.trim()],i=e.startFeeCent??0;i>0&&t.push(`${Le("card.start_fee_label")}: ${this._formatEuro(i)} €`);const n=e.blockingFeeCentMin??0,a=e.blockingFeeFromMinute??0;return n>0&&a>0&&t.push(`${this._formatCent(n)} ${Le("card.blocking_fee_label").replace("{from}",String(a))}`),t.join("\n")}_pointStatusLabel(e){if(!e)return"";const t={AVAILABLE:"available",CHARGING:"charging",OCCUPIED:"occupied",RESERVED:"reserved",BLOCKED:"blocked",OUTOFORDER:"fault",FAULTED:"fault",INOPERATIVE:"fault",UNAVAILABLE:"unavailable",UNKNOWN:"unknown",PLANNED:"planned",REMOVED:"removed"}[this._normStatus(e)];if(!t)return e;const i=`card.point_status_${t}`,n=Le(i);return n===i?e:n}_renderOpeningHoursSection(e,t){if(!e||0===e.length)return j;const i=this._formatOpeningHours(e);if(0===i.length)return j;const n=!0===t?"status-ok":!1===t?"status-inactive":null,a=!0===t?Le("card.open_now"):!1===t?Le("card.closed_now"):null;return B`
