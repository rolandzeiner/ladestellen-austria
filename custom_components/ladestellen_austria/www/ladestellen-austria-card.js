...
`;var Ot,Tt;!function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(Ot||(Ot={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(Tt||(Tt={}));const Mt=(t,e,i,a)=>{a=a||{},i=null==i?{}:i;const s=new Event(e,{bubbles:void 0===a.bubbles||a.bubbles,cancelable:Boolean(a.cancelable),composed:void 0===a.composed||a.composed});return s.detail=i,t.dispatchEvent(s),s},Lt=["Type 2","CCS","CHAdeMO","Type 1","Tesla","Schuko","CEE"];let Ut=class extends ot{constructor(){super(...arguments),this._config={type:"ladestellen-austria-card"}}setConfig(t){this._config={...t}}render(){Et(this.hass?.language);const t=this._config.connector_types??[];return F`
    ...
    `}_toggleConnector(t){const e=this._config.connector_types??[],i=e.includes(t)?e.filter(e=>e!==t):[...e,t];this._config={...this._config,connector_types:i},Mt(this,"config-changed",{config:this._config})}_valueChanged(t){if(!this._config||!this.hass)return;const e=t.target;if(!e.configValue)return;const i=void 0!==e.checked?e.checked:t.detail?.value??e.value;this._config[e.configValue]!==i&&(this._config={...this._config,[e.configValue]:i},Mt(this,"config-changed",{config:this._config}))}static{this.styles=Pt}};t([pt({attribute:!1})],Ut.prototype,"hass",void 0),t([ut()],Ut.prototype,"_config",void 0),Ut=t([ct("ladestellen-austria-card-editor")],Ut),console.info(`%c  Ladestellen Austria Card  %c  ${St("common.version")} 0.1.0-beta-26  `,"color: white; font-weight: bold; background: #3FA535","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"ladestellen-austria-card",name:"Ladestellen Austria",description:"Nearby EV charging stations, powered by E-Control Austria",preview:!0,documentationURL:"https://github.com/rolandzeiner/ladestellen-austria"});let Nt=class extends ot{constructor(){super(...arguments),this._expanded=new Set}static getConfigElement(){return document.createElement("ladestellen-austria-card-editor")}static getStubConfig(t,e){const i=e.find(t=>t.startsWith("sensor.")&&t.includes("ladestelle"));return{entity:i??""}}setConfig(t){if(!t)throw new Error(St("common.invalid_configuration"));this.config={name:"Ladestellen Austria",max_stations:10,show_hero:!0,show_amenities:!0,show_pricing:!0,sort_by_power:!1,logo_adapt_to_theme:!1,only_available:!1,only_free:!1,connector_types:[],...t}}shouldUpdate(t){if(!this.config)return!1;if(t.has("config")||t.has("_expanded"))return!0;const e=t.get("hass");return!e||!this.config.entity||e.states[this.config.entity]!==this.hass.states[this.config.entity]}getCardSize(){const t=this.config?.max_stations??10;return Math.min(3+Math.ceil(t/3),10)}render(){if(Et(this.hass?.language),!this.hass||!this.config)return F`<ha-card
      ...
      `;const e=t.attributes.stations??[],i=!0===t.attributes.live_status_available,a=this._filterStations(e),s=a[0],n=this._sortStations(a),r=Math.max(1,this.config.max_stations??10),o=n.slice(0,r),l=o[o.length-1],c=!1!==this.config.show_hero,d=this.config.name&&"Ladestellen Austria"!==this.config.name?this.config.name:null;return F`
      <ha-card>
    ...
    `}_renderHero(t,e,i,a){if(!t)return F`<div class="hero hero--empty">
      ...
      </div>`;const s=this._formatKm(t.distance),n=this._heroCity(t),r=e?this._formatKm(e.distance):s,o=St("card.hero_range").replace("{min}",this._formatKm(t.distance)).replace("{max}",r),l=i===a?St("card.hero_count").replace("{count}",String(i)):St("card.hero_count_filtered").replace("{filtered}",String(i)).replace("{total}",String(a));return F`
      <div class="hero">
        ...
        <div class="hero-context">
          <div class="hero-context-1">
            ${St("card.hero_context").replace("{city}",n)}
          </div>
          <div class="hero-context-2">${l} · ${o}</div>
        </div>
      </div>
    `}_heroCity(t){return t.city||t.label||""}_renderStation(t,e){const i=t.points??[],a=i.some(t=>(t.electricityType??[]).includes("DC")),s=i.reduce((t,e)=>Math.max(t,e.capacityKw??0),0),n=Array.from(new Set(i.flatMap(t=>(t.connectorType??[]).map(t=>this._shortConnector(t.consumerName,t.key))))),r=n.slice(0,3),o=n.length-r.length,l=this._priceText(i),c=i.some(t=>t.freeOfCharge),d=i.length,h=i.filter(t=>"AVAILABLE"===t.status).length,p="ACTIVE"===t.stationStatus,u=this._statusLevel(e,p,h,d),g=this._expanded.has(t.stationId),f=`https://www.google.com/maps/search/?api=1&query=${t.location.lat},${t.location.lon}`,m=this.config?.show_amenities??!0,v=this.config?.show_pricing??!0;return F`
      <li
        ...
        <div class="station-body">
          ...
          <div class="station-grid">
            <span class="station-metrics">
              ...
              ${r.map(t=>F`<span class="pill plug">${t}</span>`)}
            ...
            ${v&&l?F`<span
                  ...
                  >${l}</span
                >`:F`<span class="metric-price-placeholder"></span>`}
            <ha-icon
              class="chevron"
    ...
    `}_renderStationDetail(t,e,i,a,s,n,r){const o=this._amenityItems(t),l=a||!s,c=this._address(t);return F`
      <div class="detail">
        ${l?F`<div class="detail-section">
              <div class="detail-label">${St("card.availability")}</div>
              ${this._statusLine(a,s,e,i)}
            </div>`:K}
        ${n&&o.length>0?F`<div class="detail-section">
